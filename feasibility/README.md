...
The build is intentionally independent of MoCHi and real providers. It uses the locally installed Android SDK/JDK tools and signs with a local prototype key. The resulting APK hash and certificate are recorded in `07-reports/01-baseline-and-experiment-setup.md`.
